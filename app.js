...
const interviewData = [
    ...
    },
    {
        category: "二十、综合场景题",
        items: [
            { title: "20-1-有没有抓过包，为什么要抓包，具体怎么做的", file: "docs/20-1-有没有抓过包，为什么要抓包，具体怎么做的-.md" },
            { title: "20-2-为什么要进行抓包-具体怎么分析的", file: "docs/20-2-为什么要进行抓包-具体怎么分析的-.md" },
            { title: "20-3-大概给我讲下抓包的原理", file: "docs/20-3-大概给我讲下抓包的原理-.md" },
            { title: "20-4-给你一个需求，你具体讲下，你怎么测试", file: "docs/20-4-给你一个需求，你具体讲下，你怎么测试-.md" },
            { title: "20-5-给你一个项目，你怎么展开工作，请详细说一下，你具体怎么做的", file: "docs/20-5-给你一个项目，你怎么展开工作，请详细说一下，你具体怎么做的.md" },
            { title: "20-6-项目快上线因为开发延迟，测试时间被压缩怎么做？", file: "docs/20-6-项目快上线因为开发延迟，测试时间被压缩怎么做？.md" },
            { title: "20-7-如果时间比较紧的话，你怎么安排你的工作", file: "docs/20-7-如果时间比较紧的话，你怎么安排你的工作.md" },
            { title: "20-8-返回数据现在有问题，怎么排查问题", file: "docs/20-8-返回数据现在有问题，怎么排查问题-.md" },
            { title: "20-9-有时候下订单成功有时候下单失败是什么原因", file: "docs/20-9-有时候下订单成功有时候下单失败是什么原因.md" },
            { title: "20-10-APP出现崩溃时怎么抓取日志", file: "docs/20-10-APP出现崩溃时怎么抓取日志.md" },
            { title: "20-11-微信里面，如果大家都看不到你发的朋友圈信息，分析下什么原因", file: "docs/20-11-微信里面，如果大家都看不到你发的朋友圈信息，分析下什么原因.md" },
            { title: "20-12-微信里面，如果只是B看不到，其他朋友都可以看到，分析下什么原因", file: "docs/20-12-微信里面，如果只是B看不到，其他朋友都可以看到，分析下什么原因.md" },
            { title: "20-13-你测试数据是从哪里获得-怎么获得的，假如不告诉你，你怎么处理", file: "docs/20-13-你测试数据是从哪里获得-怎么获得的，假如不告诉你，你怎么处理-.md" }
        ]
    },
    {
        category: "二十一、测试管理",
        items: [
            { title: "21-1-员工的绩效考核，量化标准", file: "docs/21-1-员工的绩效考核，量化标准.md" },
            { title: "21-2-你组内有一个技术比你牛逼年轻的组员不服你，你会怎么处理", file: "docs/21-2-你组内有一个技术比你牛逼年轻的组员不服你，你会怎么处理.md" },
            { title: "21-3-你的组员提交的bug开发不认同而吵起来了，你怎么处理", file: "docs/21-3-你的组员提交的bug开发不认同而吵起来了，你怎么处理.md" }
        ]
    }
];
